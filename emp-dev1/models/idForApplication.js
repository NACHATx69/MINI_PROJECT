...
async function genIDapp() {
  try {
    ...
    const query = `SELECT COUNT(*) AS emp_count FROM REQ_LIST WHERE SUBSTR(REQ_LIST_ID, 1, 8) = :countId`;
    ...
    const id_app = currentYear + currentMonth + currentDay + paddedSequence;
